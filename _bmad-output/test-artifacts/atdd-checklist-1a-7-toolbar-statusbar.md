...
| S7.2 | No `i18n.ts` or `useTranslation()` imports in toolbar/statusbar source files                                                                                    | Component | P2       | Fails if i18n imported (SDR: no i18n) |
...
| S9.5 | 量纲概要 slot hidden (SDR: hidden in 1a.7, will be wired later)                          | Component | P1       | Fails if 量纲 renders visible content    |
